*&---------------------------------------------------------------------*
*& Report ZRAHUL_HANA_05
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZRAHUL_HANA_05.
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
TOPICS - 1) SIMPLE OIA SENARIO [ACCOUNTS RECEIVABLE].
...
SELECT * FROM SNWD_SO_INV_HEAD AS HEAD INNER JOIN SNWD_BPA AS BPA 
...
"""  6. TOTAL NUMBER OF INVOICES / COUNT WILL GIVE THE AVERAGE.
        ...
        CONVERT TIME STAMP LS_DAYS-head-CHANGED_AT TIME ZONE SY-zonlo INTO DATE DATA(LV_DATE).
        
        """" DIFFERENCE BETWEEN LAST CHANGED DATE AND TODAYS DATE.
        
        LS_OPEN_DAYS-open_days = SY-DATUM - LV_DATE.
...
"""" WHICH IS DONE ABOVE IN THE LOOP FOR LS_OIA.
